...
public class Dungeon {
    ...
    private void initializeRooms() {
        ...
        rooms[0] = new RoomData(PathFinder.findFile("misc/Rooms/Room1.png"), 200, 200);
        rooms[0].addDoor(new Door(300, 180, 35, 40, 1)); // дверь справа
        rooms[0].addKey();

        // вторая. дверь справа и слева.
        rooms[1] = new RoomData(PathFinder.findFile("misc/Rooms/Room2.png"), 200, 200);
        rooms[1].addDoor(new Door(50, 180, 40, 40, 0)); // дверь слева
        rooms[1].addDoor(new Door(300, 180, 35, 40, 2)); // дверь справа
        rooms[1].addKey();
        

        rooms[2] = new RoomData(PathFinder.findFile("misc/Rooms/Room3.png"), 200, 200);
