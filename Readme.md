### TODO
- мелкие проблемы (
    + сундуки поправить (ян)
    - красивые комменты (и на англе надо) (моня)
    + в первый сундук инструкцию (ян)
    - в последний сундук картинку с лектором и надпись you won (ян)
    - спрайты (моня)
    + уровни сложности добвить нормально
    - поправить картинки в мини-игре под маштаб - нужно уточнить как
    + открытый оставляем?
    + когда на шифт нажимаешь оно побольше скорость делает
    + сделать силу
    - подкорректировать сложность - потестить какая норм
    + исправить область ключа
    )
